...
### v2.0.8
- 简化了config.py
- 移除了path_utils.py中的无用代码
- 删除了font2(华文中华)
- 把比较少用的几个文件扔到utils文件夹了
...
- 修复了主界面标签页显示不正确的bug
- 简化了样式窗口的相关代码
- 修复了buttonBox没有汉化的bug

### v2.0.2
- 修复了情感匹配出错后不显示错误提示在ui上的问题
- 简化了情感匹配初始化部分的代码
- 简化了图层缓存机制
- 修复了背景下拉框的一个初始化bug
...
- 支持同时控制多个角色组件的角色
- 支持使用纯色背景
- 移除了text_configs.yml，其内容已合并至chara_meta.yml
- 背景文件没有文件名格式限制了
...
### v1.6.8
- 尝试提升了图片合成的性能
- 修复了使用角色颜色作为强调色未生效的bug
- 修复了某些情况下瞎用括号导致文本着色不正确的bug

### v1.6.7
- 移除了ui上的角色和背景的缓存及预加载功能
- 修复了部分图片加载出错的问题
- 修复了表情下拉选框没有正确刷新的bug
- 整理了一下代码

### v1.6.6
- 使用cpp编译的dll优化了图片合成性能
- 移除了角色和背景的缓存及预加载功能
...
## To-Do List
1. 支持使用psd作为角色素材（用图层组区分不同姿势，在内部再使用图层组区分表情以及动作）
2. py加载psd，cpp端需要能够接收图片并缓存

## BUG记录
1. 复杂的组合emoji无法正常显示，比如 👨‍👩‍👧‍👦 👨🏻‍👩🏼‍👧🏽‍👦🏾 （不修）